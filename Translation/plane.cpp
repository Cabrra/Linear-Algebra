...
void Planes::CreatePlane(LPDIRECT3DDEVICE9 theDevice , LPCSTR textureFilename)
{
	...
	v[0]=Vertex(-DIM,-2.5f,-DIM,0.0f,1.0f,0.0f,0.0f,0.1f);  
	v[1]=Vertex(-DIM,-2.5f, DIM,0.0f,1.0f,0.0f,0.0f,0.0f);
	v[2]=Vertex( DIM,-2.5f, DIM,0.0f,1.0f,0.0f,1.0f,0.0f);
	v[3]=Vertex(-DIM,-2.5f,-DIM,0.0f,1.0f,0.0f,0.0f,1.0f);
	v[4]=Vertex( DIM,-2.5f, DIM,0.0f,1.0f,0.0f,1.0f,0.0f);
	v[5]=Vertex( DIM,-2.5f,-DIM,0.0f,1.0f,0.0f,1.0f,1.0f);
	Floor->Unlock();
