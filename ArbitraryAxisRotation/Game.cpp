...
bool cGame::InitializeGame()
{
	...
	ground.CreatePlane(Device,"desert.bmp");
	 ...
	 //TODO : create box 1 , with texture filename being crate.jpg
	box1.CreateCube(Device, "crate.jpg");
	// TODO : set box 1  position at (-30,20,-30)
	box1.position = D3DXVECTOR3(-30.0f, 20.0f, -30.0f);   
	//TODO : create box 2 , with texture filename being crate.jpg
	box2.CreateCube(Device, "crate.jpg");
	//TODO : set box 2  position at (8,5,-80)
	box2.position = D3DXVECTOR3(8.0f, 5.0f, -80.0f);
	...
	// create  pillar with position at (-5,0,-1) and with an orientation of 90 degree
...
{
    // TODO : update box 1 by calling update(dt)
	box1.Update(dt);
    //TODO :update box 2 by calling update(dt)
	box2.Update(dt);
...
INT WINAPI WinMain (HINSTANCE hInstance, HINSTANCE hPrevInst,LPSTR lpCmdLine, int nShowCmd)
{
 ...
 game=new cGame();
  /* Create window */
 game->CreateGameWindows(hInstance," Linear Algebra: Arbitrary axis Rotation simulation");
