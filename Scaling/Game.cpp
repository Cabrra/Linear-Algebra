...
bool cGame::InitializeGame()
{
	...
	// create the ground with texture filename being "desert.bmp"
	ground.CreatePlane(Device, "desert.bmp");
	 // create box 1 , with texture filename being crate.jpg
	box1.CreateCube(Device, "crate.jpg");
	// set box 1  position at (-30,25,-30)
	box1.position = D3DXVECTOR3(-30.0f, 25.0f, -30.0f);
	// create box 2 , with texture filename being crate.jpg
	box2.CreateCube(Device, "crate.jpg");
	// set box 2  position at (10,35,-15)
	box2.position = D3DXVECTOR3(10.0f, 35.0f, -15.0f);    
	// create  pillar 1 with at position (-5,0,-1) and with an orientation of 90 degree
     // Remember  180=PI in DirectX is D3DX_PI
...
INT WINAPI WinMain (HINSTANCE hInstance, HINSTANCE hPrevInst,LPSTR lpCmdLine, int nShowCmd)
{
 ...
 game=new cGame();
  /* Create window */
 game->CreateGameWindows(hInstance," Linear Algebra: Scaling simulation");
